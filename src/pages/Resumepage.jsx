        ...
        <a href="/Elli-McKinley-Resume-MASTER.pdf" download className="btn btn-accent-custom">
          Download CV
            ...
            <section className="mt-4">
                <h2>ELLI MCKINLEY</h2>
                <p>Glenwood Springs, CO | elli.mckinley@gmail.com | <a href="https://www.linkedin.com/in/ellimckinley/" target="_blank" rel="noopener noreferrer">linkedin.com/in/ellimckinley/</a></p>
            </section>
            ...
            <section className="mt-4">
                ...
                <div>
                    ...
                    <ul>
                        <li>HTML, CSS, JavaScript, Web APIs, node.js, TypeScript, Servers and APIs, SQL, 
                        Prompt Engineering, React, NoSQL, MERN and Authentication, Python</li>
                    </ul>
                </div>
                <div>
